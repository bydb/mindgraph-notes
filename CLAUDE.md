...
- **Retrieval** (`vaultRetrieve.ts`): Cosine-only, Oversampling 4×K, exaktes Dedupe (normalisierter Text), Pro-Datei-Deckel 2, Floor 0,30 **ohne Top-1-Fallback** (unter Floor: deterministisch „nichts gefunden", kein Modellaufruf). Schwellen erst nach Phase-3-Messung anfassen.
