...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  noteAgentAcceptResult: (runId: string, resultId: string, timings?: { reviewMs?: number; waitingMs?: number }) => ipcRenderer.invoke('note-agent-accept-result', runId, resultId, timings),
  noteAgentDiscardResult: (runId: string, resultId: string, timings?: { reviewMs?: number; waitingMs?: number }) => ipcRenderer.invoke('note-agent-discard-result', runId, resultId, timings),
