...
export interface ElectronAPI {
  ...
  imageGenerate: (params: { prompt: string; aspectRatio?: '16:9' | '4:3' | '1:1' | '3:4' | '9:16' }) => Promise<{ success: boolean; imageBase64?: string; mimeType?: string; fileExtension?: string; error?: string }>;
  ...
  calendarCreateEvent: (params: { title: string; startIso: string; durationMinutes: number; notes?: string; location?: string; url?: string; reminderMinutes?: number[] ; allDay?: boolean; endDate?: string }) => Promise<{ success: boolean; eventId?: string; error?: string; needsPermission?: boolean }>;
