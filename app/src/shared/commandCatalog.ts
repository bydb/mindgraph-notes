...
const RAW_COMMAND_CATALOG = [
  ...
  { id: 'panel-agent', labelKey: 'commandPalette.panelAgent', categoryKey: 'commandPalette.cat.panels', keywords: 'edoobox veranstaltungen events akkreditierung buchungen', requires: 'edoobox' },
