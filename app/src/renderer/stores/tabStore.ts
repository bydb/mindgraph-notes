...
/** Sprung zu einer Quellenstelle (Vault-Chat): an Notiz und Anfrage gebunden, wird erst nach
 *  Laden derselben Inhaltsfassung (sourceHash) konsumiert — nie ein stiller Sprung. */
