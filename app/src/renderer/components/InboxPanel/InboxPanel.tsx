...
export const InboxPanel: React.FC<InboxPanelProps> = ({ onClose }) => {
  ...
  // View-Switcher Header (shared across all views) — geteilter PanelHeader (Karteikarten-Standard)
  const renderHeader = (showBack?: boolean, backAction?: () => void) => (
    <PanelHeader
      ...
      title={t('inbox.title')}
      onBack={showBack ? backAction : undefined}
      backTitle={t('inbox.detail.back')}
      onClose={onClose}
