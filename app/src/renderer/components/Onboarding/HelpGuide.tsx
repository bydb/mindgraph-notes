...
const icons: Record<string, React.ReactNode> = {
  ...
  canvas: <><circle cx="5" cy="6" r="2"/><circle cx="19" cy="6" r="2"/><circle cx="12" cy="18" r="2"/><line x1="7" y1="6" x2="17" y2="6"/><line x1="6" y1="8" x2="11" y2="16"/><line x1="18" y1="8" x2="13" y2="16"/></>,
...
const helpTopics: HelpTopic[] = [
  // Core (center)
  { id: 'start', label: 'MindGraph', icon: 'mindgraph', color: '#e8685a', category: 'core',
    details: ['Markdown-Notizen mit Wissensgraph', 'Wikilinks mit [[ verbinden Notizen', 'Split-Ansicht: Editor + Graph', 'MindGraph: Dein Wissen als Netzwerk'] },
  ...
  { id: 'antares', label: 'Antares', icon: 'book', color: '#10b981', category: 'integrate',
    details: ['Medienzentrum-Daten aus Antares CS im Dashboard sichtbar machen', 'Zeigt offene Registrierungen, Anfragen, Vorbestellungen und Mahnungen', 'Nutzt deinen eigenen Antares-Account lokal in MindGraph', 'Zugangsdaten in Einstellungen → Antares hinterlegen'],
    action: { id: 'openSettingsTab', label: 'Antares einrichten', settingsTab: 'plugin:antares' } },
