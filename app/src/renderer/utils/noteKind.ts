...
import {
  ...
  resolveNoteDate
} from '../../shared/noteKind'
import type { NoteKindId, NoteKindDefinition, NoteDate, NoteDateSource } from '../../shared/noteKind'

// Der reine Kern (Kategorien, Erkennung, Datum) liegt in `shared/noteKind.ts`, weil
// der Main ihn für den Vault-Index braucht. Hier bleibt die Renderer-Fassade mit
// `Note`-Typ und den Frontmatter-Schreibern — Importpfade im Renderer unverändert.
export {
  NOTE_KINDS,
  getNoteKindFromContent,
  getNoteKindFromMarker,
...
export type { NoteKindId, NoteKindDefinition, NoteDate, NoteDateSource }
